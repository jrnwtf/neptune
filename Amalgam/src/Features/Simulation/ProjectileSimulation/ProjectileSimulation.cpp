...
bool CProjectileSimulation::Initialize(ProjectileInfo& tInfo, bool bSimulate)
{
	...
	//set position and velocity
	{
		...
		case TF_PROJECTILE_CANNONBALL:
			...
			{
				CValve_Random* Random = new CValve_Random();
				Random->SetSeed(*G::RandomSeed());
				vVelocity += vUp * 200.f + vUp * Random->RandomFloat(-10.f, 10.f)/*SDK::RandomFloat(-10.f, 10.f)*/ + vRight * Random->RandomFloat(-10.f, 10.f)/*SDK::RandomFloat(-10.f, 10.f)*/;
				vAngularVelocity = { 600.f, float(Random->RandomInt(-1200, 1200)/*SDK::RandomInt(-1200, 1200)*/), 0.f };
				break;
			}
			vVelocity += vUp * 200.f;
