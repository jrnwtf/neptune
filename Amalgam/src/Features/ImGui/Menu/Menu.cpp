	...
	case 0:
		if (BeginTable("VisualsESPTable", 2))
		{
			...
			if (Section("ESP"))
			{
				...
				{
					FDropdown("Player", Vars::ESP::Player, { "Enemy", "Team", "Local", "Prioritized", "Friends", "Party", "##Divider", "Name", "Name background", "Box", "Distance", "Bones", "Health bar", "Health text", "Uber bar", "Uber text", "Class icon", "Class text", "Weapon icon", "Weapon text", "Priority", "Labels", "Buffs", "Debuffs", "Misc", "Lag compensation", "Ping", "KDR", "That's how mafia works" }, {}, FDropdown_Multi, 0, "None", nullptr, "Player ESP");
				}
				PopTransparent();
				PushTransparent(!(FGet(Vars::ESP::Draw) & Vars::ESP::DrawEnum::Buildings));
				{
					FDropdown("Building", Vars::ESP::Building, { "Enemy", "Team", "Local", "Prioritized", "Friends", "Party", "##Divider", "Name", "Name background", "Box", "Distance", "Health bar", "Health text", "Owner", "Level", "Flags" }, {}, FDropdown_Multi, 0, "None", nullptr, "Building ESP");
				}
				PopTransparent();
				PushTransparent(!(FGet(Vars::ESP::Draw) & Vars::ESP::DrawEnum::Projectiles));
				{
					FDropdown("Projectile", Vars::ESP::Projectile, { "Enemy", "Team", "Local", "Prioritized", "Friends", "Party", "##Divider", "Name", "Name background", "Box", "Distance", "Owner", "Flags" }, {}, FDropdown_Multi, 0, "None", nullptr, "Projectile ESP");
				}
				PopTransparent();
				PushTransparent(!(FGet(Vars::ESP::Draw) & Vars::ESP::DrawEnum::Objective));
				{
					FDropdown("Objective", Vars::ESP::Objective, { "Enemy", "Team", "##Divider", "Name", "Name background", "Box", "Distance", "Flags", "Intel return time" }, {}, FDropdown_Multi, 0, "None", nullptr, "Objective ESP");
				}
				PopTransparent();
			} EndSection();
	...
	case 2:
		if (BeginTable("VisualsGlowTable", 2))
		{
			...
			if (Section("Player", true))
			{
				...
				{
					FSlider("Stencil scale## Player", Vars::Glow::Player::Stencil, 0, 10, 1, "%i", FSlider_Left | FSlider_Min, nullptr, "Friendly stencil scale");
				}
				PopTransparent();
				PushTransparent(!FGet(Vars::Glow::Player::Blur));
				{
					FSlider("Blur scale## Player", Vars::Glow::Player::Blur, 0, 10, 1, "%i", FSlider_Right | FSlider_Min, nullptr, "Friendly blur scale");
				}
				PopTransparent();
			} EndSection();
			...
			if (Section("Team", true))
			{
				...
				FToggle("Distance to alpha## Team", Vars::Glow::Team::Dist2Alpha, FToggle_Left, nullptr, "Distance to alpha team glow");
				FSlider("Max render distance## Team", Vars::Glow::Team::MaxDist, 512, 4096, 128, "%i", FSlider_Clamp, nullptr, "Max render dist team glow");
				FSlider("Min render distance## Team", Vars::Glow::Team::MinDist, 0, 2048, 128, "%i", FSlider_Clamp, nullptr, "Min render dist team glow");
