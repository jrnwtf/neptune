...
MAKE_HOOK(CProxyAnimatedWeaponSheen_OnBind, S::CProxyAnimatedWeaponSheen_OnBind(), void, CProxyAnimatedWeaponSheen* rcx, void* pEntity)
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::CProxyAnimatedWeaponSheen_OnBind[DEFAULT_BIND])
