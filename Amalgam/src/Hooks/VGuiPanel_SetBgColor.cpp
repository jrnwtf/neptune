...
MAKE_SIGNATURE(VGuiPanel_SetBgColor, "client.dll", "89 91 ? ? ? ? C3 CC CC CC CC CC CC CC CC CC 48 8B 41", 0x0);
...
MAKE_HOOK(VGuiPanel_SetBgColor, S::VGuiPanel_SetBgColor(), void, void* rcx, Color_t color)
{
#ifdef DEBUG_HOOKS
