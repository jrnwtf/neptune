...
inline Color_t GetScoreboardColor(int iIndex, bool enableOtherColors)
{
    Color_t out = { 0, 0, 0, 0 };
...
MAKE_HOOK(CTFPlayerResource_GetPlayerConnectionState, S::CTFPlayerResource_GetPlayerConnectionState(), MM_PlayerConnectionState_t, void* rcx, int iIndex)
{
...
MAKE_HOOK(CPlayerResource_GetTeamColor, S::CPlayerResource_GetTeamColor(), unsigned char*, void* rcx, int iIndex)
{
