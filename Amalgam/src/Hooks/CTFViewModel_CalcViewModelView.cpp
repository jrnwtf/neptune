...
MAKE_HOOK(CTFViewModel_CalcViewModelView, Signatures::CTFViewModel_CalcViewModelView.Get(), void, void* rcx, CBasePlayer* owner, const Vector &eyePosition, const QAngle &eyeAngles)
{
